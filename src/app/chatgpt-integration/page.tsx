        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-slate-400 mb-10 max-w-3xl mx-auto">
              We design and ship production-grade ChatGPT integrations: secure APIs, RAG knowledge bases,
              tool/function calling, CRM/helpdesk workflows, and analytics—built for reliability and ROI.
            </p>
