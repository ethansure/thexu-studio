...
import { Bot, Brain, Zap, Shield, ArrowRight, CheckCircle, Settings, Cpu, Network, MessageSquare } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-slate-400 text-lg max-w-3xl mx-auto">
              ...
              and execute complex tasks. Unlike simple chatbots, AI agents can use tools, access APIs, 
              browse the web, and make decisions to accomplish goals.
            </p>
          </motion.div>

          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { icon: MessageSquare, title: 'Conversational AI', desc: 'Natural language interfaces for customer support, sales, and internal help desks' },
              { icon: Cpu, title: 'Task Automation', desc: 'Autonomous agents that execute multi-step workflows without human intervention' },
              { icon: Network, title: 'Multi-Agent Systems', desc: 'Coordinated agent teams that collaborate to solve complex problems' },
              { icon: Settings, title: 'Tool Integration', desc: 'Agents that use APIs, databases, and external services to accomplish tasks' }
            ].map((item, i) => (
              <motion.div
                key={item.title}
      ...
      <section className="py-20 px-6 bg-slate-900/50">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {[
              { title: 'Customer Support Agents', desc: 'AI agents that handle customer inquiries 24/7, resolve issues, and escalate complex cases to humans.' },
              { title: 'Sales & Lead Qualification', desc: 'Intelligent agents that engage prospects, qualify leads, and schedule meetings automatically.' },
              { title: 'Personal Assistants', desc: 'AI agents that manage calendars, emails, tasks, and reminders for busy professionals.' },
              { title: 'Research & Analysis', desc: 'Agents that gather information, analyze data, and generate reports autonomously.' },
              { title: 'Code Development', desc: 'AI coding agents that write, review, and debug code to accelerate software development.' },
              { title: 'Content Creation', desc: 'Agents that generate, edit, and publish content across multiple platforms.' }
            ].map((useCase, i) => (
              <motion.div
                key={useCase.title}
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-slate-300 text-lg mb-8">
              Let&apos;s discuss your use case and design the perfect AI agent for your business.
