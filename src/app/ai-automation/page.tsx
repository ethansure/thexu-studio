          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              },
              {
                ...
                desc: 'Role-based access, audit logs, PII controls, and fallbacks when confidence is low.',
              },
            ].map((item, i) => (
              <motion.div
                key={item.title}
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {[
              ...
              },
              {
                ...
                desc: 'Turn SOPs into agent workflows: onboarding, checklists, and self-serve answers in Slack.',
              },
            ].map((useCase, i) => (
              <motion.div
                key={useCase.title}
        ...
        <div className="max-w-7xl mx-auto">
          <div className="bg-slate-800/30 border border-slate-700 rounded-2xl p-8 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
            <div>
              ...
              <p className="text-slate-400">Explore AI chatbots and integrations to complete the loop.</p>
            </div>
            <div className="flex flex-wrap gap-3">
              <Link href="/ai-chatbot" className="bg-slate-900 border border-slate-700 px-5 py-3 rounded-xl hover:bg-slate-800 transition">
                AI Chatbots
              </Link>
              <Link href="/chatgpt-integration" className="bg-slate-900 border border-slate-700 px-5 py-3 rounded-xl hover:bg-slate-800 transition">
                ChatGPT Integration
              </Link>
              <Link href="/ai-agents" className="bg-slate-900 border border-slate-700 px-5 py-3 rounded-xl hover:bg-slate-800 transition">
                AI Agents
              </Link>
            </div>
          </div>
